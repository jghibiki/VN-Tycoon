...
#    style.help_bar_vbar.top_bar  = "gui/config_bar_full.png"
    #style.help_bar_vbar.right_bar = "gui/config_bar_empty.png"
...
init:
    ...
    $ button_text = "Start"
    image m_button_start = At(LiveComposite ((312, 80), (0,0), "gui/main_button.png", (8, 6), Text(button_text, style="main_butt")), main_eff)
    image m_button_start_hover = At(LiveComposite ((312, 80), (0,0), "gui/main_button.png", (3, 1), Text(button_text, style="main_butt_hover")), main_eff)

    $ button_text = "Load"
    image m_button_load = At(LiveComposite ((312, 80), (0,0), "gui/main_button.png", (8, 6), Text(button_text, style="main_butt")), main_eff)
    image m_button_load_hover = At(LiveComposite ((312, 80), (0,0), "gui/main_button.png", (3, 1), Text(button_text, style="main_butt_hover")), main_eff)

    $ button_text = "Config"
    image m_button_config = At(LiveComposite ((312, 80), (0,0), "gui/main_button.png", (8, 6), Text(button_text, style="main_butt")), main_eff)
    image m_button_config_hover = At(LiveComposite ((312, 80), (0,0), "gui/main_button.png", (3, 1), Text(button_text, style="main_butt_hover")), main_eff)

    $ button_text = "Extras"
    image m_button_extras = At(LiveComposite ((312, 80), (0,0), "gui/main_button.png", (8, 6), Text(button_text, style="main_butt")), main_eff)
    image m_button_extras_hover = At(LiveComposite ((312, 80), (0,0), "gui/main_button.png", (3, 1), Text(button_text, style="main_butt_hover")), main_eff)

    $ button_text = "Help"
    image m_button_help = At(LiveComposite ((312, 80), (0,0), "gui/main_button.png", (8, 6), Text(button_text, style="main_butt")), main_eff)
    image m_button_help_hover = At(LiveComposite ((312, 80), (0,0), "gui/main_button.png", (3, 1), Text(button_text, style="main_butt_hover")), main_eff)

    $ button_text = "Quit"
    image m_button_quit = At(LiveComposite ((312, 80), (0,0), "gui/main_button.png", (8, 6), Text(button_text, style="main_butt")), main_eff)
    image m_button_quit_hover = At(LiveComposite ((312, 80), (0,0), "gui/main_button.png", (3, 1), Text(button_text, style="main_butt_hover")), main_eff)
    
# screen snow:
    # zorder -1
    # window:
        # background SnowBlossom(Animation("gui/frame.png", 0.15, "gui/frame.png", 0.15))
# init:
...
screen main_menu:
    ...
    vbox xalign .5 yalign .5:
        for item in main_menu_items:
            ...
            button background None focus_mask True action [Hide("gui_tooltip"), my_action] hovered [ Play ("sound", "sfx/click.wav"), Show("gui_tooltip", my_picture=tip_name) ] unhovered [Hide("gui_tooltip")]:
                add button_name
...
init:
    ...
    $ x = 50
    $ button_text = "Return"
    image button_return = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt")), side_eff)
    image button_return_selected_idle = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_idle)
    image button_return_selected_hover = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_hover)

    $ button_text = "Config"
    image button_config = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt")), side_eff)
    image button_config_selected_idle = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_idle)
    image button_config_selected_hover = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_hover)
    
    $ button_text = "Save Game"
    image button_save = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt")), side_eff)
    image button_save_selected_idle = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_idle)
    image button_save_selected_hover = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_hover)
    image button_save_insensitive = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt_insensitive")), side_eff_insensitive)

    $ button_text = "Load Game"
    image button_load = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt")), side_eff)
    image button_load_selected_idle = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_idle)
    image button_load_selected_hover = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_hover)

    $ button_text = "Main Menu"
    image button_main = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt")), side_eff)
    image button_main_selected_idle = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_idle)
    image button_main_selected_hover = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_hover)
    image button_main_insensitive = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt_insensitive")), side_eff_insensitive)

    $ button_text = "Help"
    image button_help = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt")), side_eff)
    image button_help_selected_idle = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_idle)
    image button_help_selected_hover = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_hover)
    
    $ button_text = "Quit"
    image button_quit = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt")), side_eff)
    image button_quit_selected_idle = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_idle)
    image button_quit_selected_hover = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_hover)
...
init:
    transform trans30:
        alpha 0.3
    image main_menu_cg="bg/home day.jpg"
...
screen navigation:
    ...
    vbox xpos 1060 ypos 129 spacing 9:
        for item in game_menu_items:
            ...
            $ tip_name = "tooltip_" + item
            $ my_action = menu_actions[item]
            button background None focus_mask True action my_action hovered [ Play ("sound", "sfx/click.wav"), Show("gui_tooltip", my_picture=tip_name) ] unhovered [Hide("gui_tooltip")]:
                add button_name
...
init:
    ...
    image button_cg_gallery = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt")), side_eff)
    image button_cg_gallery_selected_idle = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_idle)
    image button_cg_gallery_selected_hover = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_hover)

    $ button_text = "Characters"
    image button_ch_gallery = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt")), side_eff)
    image button_ch_gallery_selected_idle = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_idle)
    image button_ch_gallery_selected_hover = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_hover)

    $ button_text = "BG Gallery"
    image button_bg_gallery = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt")), side_eff)
    image button_bg_gallery_selected_idle = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_idle)
    image button_bg_gallery_selected_hover = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_hover)

    $ button_text = "Music Room"
    image button_music_room = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt")), side_eff)
    image button_music_room_selected_idle = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_idle)
    image button_music_room_selected_hover = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_hover)

    $ button_text = "Concept Art"
    image button_dev_gallery = At(LiveComposite ((335, 74), (0,0), "gui/side_button.png", (x, 18), Text(button_text, style="side_butt")), side_eff)
    image button_dev_gallery_selected_idle = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_idle)
    image button_dev_gallery_selected_hover = At(LiveComposite ((335, 74), (0,0), "gui/side_button_selected.png", (x, 18), Text(button_text, style="side_butt")), side_eff_selected_hover)
...
init -2 python:
    ...
    style.pref_text.font = "gui/animeace2_reg.ttf"
