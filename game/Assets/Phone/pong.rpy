    ...
    python:
        ...
        class PongDisplayable(renpy.Displayable):
            ...
            def __init__(self):
                ...
                self.paddle = Image("Assets/Phone/pong.png")
                self.ball = Image("Assets/Phone/pong_ball.png")
...
#                self.COURT_BOTTOM = 543
            ...
            def render(self, width, height, st, at):
                ...
                if self.by < ball_top:
                    ...
                    self.bdy = -self.bdy
                    renpy.sound.play("Assets/Phone/pong_beep.wav", channel=0)
                ...
                def paddle(px, py, hotside):
                    ...
                    if py - self.PADDLE_HEIGHT / 2 <= self.by <= py + self.PADDLE_HEIGHT / 2:
                        ...
                        if hit:
                            renpy.sound.play("Assets/Phone/pong_boop.wav", channel=1)
                            self.bspeed *= 1.10
