...
screen show_cover(game=mygame):
    ...
    if game.relationship == "bxb":
        $ sp1 = random.choice(boys)
        $ boys.remove(sp1)
        $ sp2 = random.choice(boys)
    if game.relationship == "gxg":
        $ sp1 = random.choice(girls)
        $ girls.remove(sp1)
        $ sp2 = random.choice(girls)
    if game.relationship == "gxb":
        $ sp1 = random.choice(girls)
        $ sp2 = random.choice(boys)
