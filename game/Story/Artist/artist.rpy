...
label artist:
    ...
    "Finally I gave up all the idea of ever getting to sleep and answered the phone, regretfully."
    ...
    "Yeah right, I almost scoffed."
    "Still I listen to my mother, would only cause problems to raise a fuss now, or ever."
    ...
    "Those were how my mom referred to the things I liked. Visual novels were referred to as 'fake movies in which you read all the time,' and Cartoons and Anime were for two as 'those things with not real people.'"
    Martha "Yes mother I'm still doing those."
    Mom "If you want to write movies or books you should do instead of that instead of this fake thing."
    Martha "Mother I like visual novels!"
    ...
    Martha "Well, time to get to work! I only have so long before mother will call about the deadline." 
