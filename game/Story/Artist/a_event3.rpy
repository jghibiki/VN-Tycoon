...
#Requirements: Auto - Day 4 or so
    ...
    Martha sad "I started my day checking my email to see if anything important appeared. Sadly the only important thing was notifications from stalkmepls."
    $ showBrowser = "stalkmeplz"
    show screen stalkmeplz_mom
    Martha surprise "It is a status update from my mom."
    ...
    Martha "I looked at the post, it seemed lots of people were starting to rally around my mother. Honestly where did she get such a silly idea."
    Martha annoyed "Why couldn't she be like other mothers who supported their child!"
