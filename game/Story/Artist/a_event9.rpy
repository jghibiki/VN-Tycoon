label artist_event9:
    ...
    Martha "And each time we replied back and forth between each other a smile would beam on my face. After a while we decided that Lemming Soft's private messaging was just not good enough, and we shared FingerHurt instant messaging addresses."
