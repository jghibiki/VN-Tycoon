label artist_event1:
    ...
    Martha "I said in a completely casual tone ignoring her idea that I just been kidnapped."
    ...
    Martha "I didn't like how she I did the maybe at the end, I couldn't get a date or something. did she honestly think her daughter was so ugly that no one wanted to date her. Anyway it is what is on the inside that counts!"
    ...
    Martha "Yeah right, I almost scoffed."
    ...
    Martha "Those were how my mom referred to the things I liked. Visual novels were referred to as 'fake movies in which you read all the time,' and Cartoons and Anime were for two as 'those things with not real people.'"
    ...
    Marthas "Mother I like visual novels!"
