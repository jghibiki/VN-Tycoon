...
label artist_event6:
    ...
    Martha "I felt like I was making good progress but then everything just stopped."
    Martha "Something felt missing, but I didn't know what it was."
    Marthas "Hmm... something is just off."
    ...
    if inventory.has_item(tablet):
        $ pen_kind = "stylus"
    Martha "I fingered the [pen_kind] pen as I tried to think about what was wrong."
