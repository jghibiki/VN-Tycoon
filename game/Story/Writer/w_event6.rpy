...
# Scene:
label writer_event6:
    Joan neutral "Hnngg... buh, what? Who the hell's callin' me? What time is it anyway? ... Aww man... did I really sleep in 'till 2 o' again?"
    Joan neutral "Ah, dammit, where's my phone?!"
    Joan "\"Hoy, yeah, me here.\""
    Antagonist "\"Heheh, you sound as groggy as always!\""
    Joan "\"... What are you calling me for?\""
    Antagonist "\"Wow, grumpy. Were you sleeping again?\""
    Joan "\"Shut up.\""
    Antagonist "\"Man, you're such a lazybones.\""
    Joan "\"I'm going to hang up.\""
    Joan neutral "Damn, did that ass really have to call me?"
    #...
    Joan neutral "... You're calling me again, aren't you?"
    Joan "\"What?\""
    ...
    Joan neutral "... AGH, I hate that guy so much. So so so so so SO MUCH!"
    Joan neutral "Dammit, this is no time to laze around! I have to write that damn VN and show up that damn idiot. It's not hard. Holy hell, how can it even be considered hard?!"
