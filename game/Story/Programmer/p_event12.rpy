label coder_event12:
    ...
    t "Just as promised, the solution to my code awaits me in my inbox. Note to self: Never doubt Mark when he promises something related to code."
    t "I cross-check the code to mine, but it appears to be identical. Why does his work and mine crashes the program on launch? What did he do differently?"
    t "Finally, I find the coder note. A space. I forgot to make properly indent things and ended up with one line of code that was out of place. How did I miss such a stupid little thing?!"
    t "Before I close the script, I glance over the rest to make sure he didn't change things. Unsurprisingly, a fellow programmer decided to rewrite some of my code."
    ...
    t "He's never touched HenPie and he's a bloody pro at it. I refuse to believe it. There's no way that someone brand new could just sit down and do this sort of work in an evening."
    t "I am going to get to the bottom of this."
    m "Toby!"
    ts "Hey, Mark. I was looking over some of the changes you made to my script."
    m "Something wrong with them? I made sure it all worked before I sent it over."
    ts "That's the thing, Mark. How did you know what needed to be changed?"
    ...
    ts "What aren't you telling me, Mark? I want to know."
    ...
    ts "Twenty... I couldn't survive on that. I wouldn't even come close to breaking even at twenty sales."
    ...
    t "A couple?! He made me look like a freshman attending their first programming course!"
    t "If he couldn't make it... what hope do I have?"
    ts "I'll let you know. Thanks for the help."
    m "Stay strong, Toby!"
