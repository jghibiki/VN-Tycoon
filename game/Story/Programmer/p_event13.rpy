label coder_event13:
    ...
    t "My phone sits before me like an uncaring demon ready to tear out my soul. I would rather jump into a pit of boiling lava than make the phone call. I'd rather roll around on a pile of broken glass than make this call."
    ...
    ts "Because I live on first street! Why did you make me watch that terrible movie?"

    m "..."

    ts "You're a terrible person."

    m "Yep. So, what did you need?"

    t "Time to swallow my pride."

    ts "Mark... I want you to teach me how to code like you do in HemPie."
    ...
    ts "I know I'm asking for a lot. You have every right in the world to laugh in my face and walk away. I wouldn't blame you."
    ...
    ts "Someone has been reading his classic literature lately."
