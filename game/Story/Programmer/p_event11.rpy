...
#coding, day 9
    ...
    t "ABL, why must you never work for me? Why must I sit here and code again and again the same feature? I know how you are supposed to work. I know how you should work. Why can't you just work?"
    ...
    t "Once again, my mind drifts back to Mark and his offer. It would be so easy to just forget this whole thing and take back up my old job. There's no complications there."
    ...
    t "Wait... It would be the ultimate swallowing of my pride, but Mark is a very sharp programmer. I don't know if he'd be willing to help me fix my code, but I'm out of options."
    ...
    m "Toby!"
    ts "Hey, Mark. How are you?"
    m "Pretty good. Got a date with the wife in an hour or so. What's up?"
    ts "Not much. I was just having some issues with a bit of code. I was hoping you could take a look and see what I'm missing."
    ...
    ts "I'll buy you a drink after this is all done."
    m "Why don't you come out with me and Barbara? You haven't been out of the house lately."
    ts "You don't know that."
    m "..."
    ts "Okay, you do know that."
    m "Rachel has been asking about you. I'm sure she'd come along as well."
    ts "..."
    m "How about it?"
    ts "I-I-I-I'm sorry. I'm really busy tonight."
    m "Some other time then. I gotta go. Talk to you later, Toby."
    ts "See ya."
    t "I put down my cell phone. Rachel was one of my fellow interns when I first started. She was kind of cute, and we had a lot of fun working together on our menial tasks."
    t "But that life is behind me now. I'm an independent developer. I'm probably losing all of my street credit having a company man help me with my script."
    ...
    t "The only way I'll ever break out of the mold is to dedicate myself to this new frontier. Back to work."    
